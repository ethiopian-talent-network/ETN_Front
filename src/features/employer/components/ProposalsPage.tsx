...
export const ProposalsPage: React.FC<ProposalsPageProps> = ({
  ...
  // Debug logging
  console.log("ProposalsPage state:", {
    loading,
    error,
    proposals,
    filteredProposals,
      ...
      {!loading && !error && filteredProposals.length > 0 && (
        <div className="space-y-4">
          {filteredProposals.map((proposal) => (
            <div
              key={proposal.id}
              className={`p-6 rounded-lg border ${darkMode ? "border-gray-700 bg-gray-800" : "border-gray-200 bg-white"}`}
            >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3
                      ...
                      onClick={() =>
                        handleViewTalentProfile(proposal.talent_id)
                      }
                    >
